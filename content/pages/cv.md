...
# Introduction
A cheerful pragmatic. Enjoys working with other people on complex problems. Very wide field of interest. Software, maths, physics, robotics, all aspects of engineering. Seeks demanding work and interesting people!
Skilled programmer, software architect and technical leader.
I really like the process of recruiting to build a well balanced team, on-boarding, creating a good software engineering culture, and then lead the team to a common technical goal.

I am an engineer and applied researcher at heart. After some time doing mostly technical leadership,
I am now looking for a more engineering/research/tech-lead heavy position within the fields of my expertise:
...
- modeling and numerical simulation, especially PDEs, ODEs, DAEs and rigid-body dynamics

After 8 years in the robotics industry, and delivering several systems, I am very aware of the challenges of deploying robotics systems in the real world.
This makes me very well equipped to develop systems that actually work, are robust, cheap and most importantly, delivered on time.

# Key qualifications:

- Leadership of technical teams, technical project management, personnel management.
- Creating a good engineering culture, building small high performing teams.
- Experience with working with most types of engineers/researchers: field engineers, development, R&D, theoretical research and scientists, mechanical, electrical, software, structural.
- Software design, architecture, planning and testing.
- Robotics, estimation, control, optimization, mathematics, physics, mathematical modeling, simulation, real-time systems.
- Systems programming, library development.
- Design of systems with very high reliability, even systems which can do physical harm, like drone autopilot and control systems.

# Experience
- VP Software & Systems Engineering, Nordic Unmanned, Sept 2019 - Present
- CTO and co-founder, The Staaker Company, Sept 2014 - Sept 2019

# Education
- Masters in Applied Mathematics and Physics from [Norwegian University of Science and Technology](https://www.ntnu.no), 2010-2015
    - Focus on applied mathematics, modeling of physical systems, simulation and numerics.
    - PDEs, ODEs, DAEs, how to model these numerically and solve them efficiently
    - Masters thesis in computational  fluid dynamics, where I developed a simulation of the electrocoalecense happening in an crude oil seawater separator used on oil platforms. This work was implemented in FORTRAN, and used a novel combination of an eulerian simulation of the fluids, together with an lagrangian (immersed boundary) method for describing the interface between oil and water.
- Exchange to [ETH Zürich](https://ethz.ch/en.html), Switzerland, in 2014
    - Performance of low level numerical code on modern CPU-architectures, hyperbolic PDEs, numerical weather forecasting, GP-GPU processing.
- Exchange to Queensland University of Technology, Brisbane Australia in 2013
    - Modern control systems, mathematical modeling of biological systems, surf and sun!

# Management
In Nordic Unmanned, I have been so lucky that have been able to recruit my own software development team and lead them.
I have had personnel responsibility as well

# Technical Leadership
As CTO in The Staaker Company, we climbed the ladder from breadboards, loose wires and Arduino code up to a injection molded body, custom made PCBs, 
C++ firmware with reproducible builds, high code quality, and end-user product performance.

I have lead projects developing everything from batteries to production lines, robotic arms for mass calibration of drones, hard-real-time estimation and control stack, design of discrete state machine system in the Staaker drone.
I like to work with engineers, because in my heart, I am an engineer.
I love the first principles, reason-based way of getting 

In Nordic Unmanned, I have gotten the opportunity to lead technical teams in a larger organization

# Robotics, maths, physics, sensors, physics modeling, simulation etc.

# Programming
I have been programming since i was 12 years old and bought a LEGO Mindstorms set. Discovered Linux when I was 14, and have only been using it since.
I have programmed large complex systems in:

- Languages: Rust, C++, Python, Haskell
- Build systems: CMake, Make, Cargo, Meson, Stack, Pip + virtualenv
- Computer: Everything from single core STM32 MCU running FreeRTOS, via 128-core SMP Linux machines up to large 1000-core MPI clusters for scientific computing.
- OS: Linux, FreeRTOS, POSIX, custom bare metal code without OS
- VCS system: GIT
- CI: GitHub Actions / GitLab CI / JetBrains Team City
...
my mind is better at designing large systems using statically typed languages. Dynamic languages I mostly use for smaller tooling, that does not need to scale.

I have a lot experience with Linux, POSIX systems. Reading man pages, coding against C-APIs, using system calls,
threading, mutexes, semaphores, condition variables, creating libraries for other programmers to consume etc.
I understand graphics pipelines, the vertex and index buffers, shaders, the specific constraints using a GPU put on
...
It does not scale to recruiting a 100 engineers, but usually, when you are making something cutting edge, it is better with a few very good engineers, than a lot of average ones.
</details>
...
Both in The Staaker Company and in Nordic Unmanned, my job has been to lead the team towards our business goals.
A lot of this has been about clearly translating between business goals and technical goals.
As long as the technical goals are clear, and their connection to the business is explicitly defined, things go smooth.

I am used to work on both sides of business and development, and can fluidly change role given what is needed for the current situation.
</details>

<details>
<summary>
<span class="detail-header">Project management</span>
I have worked with project management all the way from an informal student startup up to an enterprise organization that is Nordic Unmanned.
Each phase of development and size of organization has it's characteristics, strengths and weaknesses.
</summary>
</details>

# Technical projects
<details>
<summary><span class="detail-header">Drone Simulator</span>
